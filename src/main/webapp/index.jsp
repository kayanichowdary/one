...
<body>
	...
	<h1 style="color: red; font-size: 40px;" align="center">123456789</h1>					
	...
	<h1 style="color: purple; font-size: 50px;" align="center">This is KALYANI's Swiggy Application </h1>
        <h1 style="color: purple; font-size: 50px;" align="center">we deployed the nexus first version </h1>
